...
<head>
	...
	<link rel="stylesheet" Type="text/css" href="encyclopediaperiodjurassicstyle.css">
...
<p> <div class="dinonames">
	...
	$result = mysql_query("SELECT * FROM `table 1` WHERE TimePeriod LIKE '%Jurassic' LIMIT 0,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE TimePeriod LIKE '%Jurassic' LIMIT 60,60");
