...
<head>
	...
	<link rel="stylesheet" Type="text/css" href="encyclopediastyle.css">
...
<p> <div class="dinonames">
	...
	$result = mysql_query("SELECT * FROM `table 1` LIMIT 0,70");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` LIMIT 70,70");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` LIMIT 140,70");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` LIMIT 210,70");
	...
	<div class="dinonames5">
	<?php
	
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` LIMIT 280,70");
