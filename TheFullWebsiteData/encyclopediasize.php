...
<head>
	...
	<link rel="stylesheet" Type="text/css" href="encyclopediasizestyle.css">
...
<p> <div class="dinonames">
	...
	$result = mysql_query("SELECT * FROM `table 1` WHERE Length <= 5  LIMIT 0,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE Length <= 5 LIMIT 60,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1`  WHERE Length <= 5  LIMIT 120,60");
