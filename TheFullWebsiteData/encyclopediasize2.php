...
<head>
	...
	<link rel="stylesheet" Type="text/css" href="encyclopediasize2style.css">
...
<p> <div class="dinonames">
	...
	$result = mysql_query("SELECT * FROM `table 1` WHERE Length BETWEEN 5.1 AND 10  LIMIT 0,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE Length BETWEEN 5.1 AND 10 LIMIT 60,60");
