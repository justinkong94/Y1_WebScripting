...
<head>
	...
	<link rel="stylesheet" Type="text/css" href="encyclopediadietstyle.css">
...
<p> <div class="dinonames">
	...
	$result = mysql_query("SELECT * FROM `table 1` WHERE Diet LIKE '%Herbivore' LIMIT 0,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE Diet LIKE '%Herbivore' LIMIT 60,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE Diet LIKE '%Herbivore' LIMIT 120,60");
	...
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE Diet LIKE '%Herbivore' LIMIT 180,60");
