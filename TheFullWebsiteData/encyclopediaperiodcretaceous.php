...
<head>
	...
	<link rel="stylesheet" Type="text/css" href="encyclopediaperiodcretaceousstyle.css">
...
<ul id="namesort">
	<li><a href="encyclopediaperiod.php">TRIASSIC</a></li>
	<li><a href="encyclopediaperiodjurassic.php">JURASSIC</a></li>
	<li><a href="encyclopediaperiodcretaceous.php">CRETACEOUS</a></li>
</ul>
...
<p> <div class="dinonames">
	...
	$result = mysql_query("SELECT * FROM `table 1` WHERE TimePeriod LIKE '%Cretaceous' LIMIT 0,60");
	...
	<div class="dinonames2">
	<?php 
	
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE TimePeriod LIKE '%Cretaceous' LIMIT 60,60");
	...
	<div class="dinonames3">
	<?php 
	
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE TimePeriod LIKE '%Cretaceous' LIMIT 120,60");
	...
	<div class="dinonames4">
	<?php 
	
	//execute the SQL query and return records
	$result = mysql_query("SELECT * FROM `table 1` WHERE TimePeriod LIKE '%Cretaceous' LIMIT 180,60");
